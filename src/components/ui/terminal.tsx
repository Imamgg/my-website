  ...
  return (
    ...
    >
      ...
      <pre
        ...
        className="p-4 overflow-y-auto overflow-x-hidden scroll-smooth flex-1"
        style={{
          maxHeight: "calc(800px - 80px)", // Account for header height
          scrollBehavior: "smooth",
        }}
      >
        <code className="grid gap-y-1 min-h-full">{children}</code>
      </pre>
    </div>
  );
};
