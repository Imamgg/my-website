export const ProjectData = [
  {
    ...
    description:
      "Discord Auto Chat is a Node.js-based script designed to automate sending messages in Discord from multiple accounts to multiple channels at customizable intervals, and features auto-replies with AI-powered answers.",
  ...
  },
  {
    title: "SIPEKA",
    description:
      "School Academic Management System is a web-based information system developed using Laravel, Tailwind CSS, and MySQL, featuring QR Code attendance and various other features designed to introduce and integrate all administrative and academic learning processes within a school environment.",
